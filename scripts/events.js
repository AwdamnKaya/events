...
function Country(name, capitalCity, language, population, sports) {
    ...
    this.sports = sports
    this.description = () => console.log(`${country.name}'s population is ${this.population}`)
}

console.log(sweden.capitalCity)
console.log(pakistan.capitalCity)
console.log(australia.capitalCity)

let sweden = new Country("Sweden", "Stockholm", "Swedish", 11000000, ["Hockey", "Handboll", "Bandy"]);
let pakistan = new Country("Pakistan", "Islamabad", "Urdu", 24000000, ["Cricket", "Hockey"]);
let australia = new Country("Australia", "Canberra", "language", 25000000, ["Cricket", "Football"]);
